...
import { AsyncEventQueue, MODAL_QUEUE } from 'events';
...
export default class Stage extends AsyncEventQueue {
  constructor(keyboard) {
    ...
    this.character.listen('character-moved', this.onCharacterMoved.bind(this));
  }
  ...
  onCharacterMoved(position) {
    if (position.x === 0 && position.y === 8) {
      MODAL_QUEUE.trigger('This door is locked');
    }
  }

...
export default class GameScene {
  ...
  initDisplay() {
    ...
    this.display.addChild(this.stage.draw());
    this.display.addChild(this.seedInventory.draw());
    this.display.addChild(this.o2meter.draw());
    this.display.addChild(this.textBox.draw());
  }

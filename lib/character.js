...
import { CallbackEventQueue } from 'events';
...
export default class Character extends CallbackEventQueue {
  ...
  update(dt) {
    ...
    this.trigger('character-moved', this.gridPosition);
  }
